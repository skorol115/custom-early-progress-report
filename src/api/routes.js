...
export class Routes {
	...
	static Users(orgUnitId, pageNumber, pageSize, sortField, sortDesc, searchTerm) { return `/d2l/api/customization/${API_VERSION}/${orgUnitId}/epr/users?sort=${sortField}&desc=${sortDesc}&pageNumber=${pageNumber}&pageSize=${pageSize}${searchTerm ? `&searchTerm=${searchTerm}` : ''}`; }
}
